...
if(is_admin())
{
add_action( 'after_setup_theme', 'wp_mail_smtp_activate' );
}
/**
...
function wp_mail_smtp_options_page() {
	...
	if (isset($_POST['wpms_action']) && $_POST['wpms_action'] == __('Send Test', 'wp_mail_smtp') && isset($_POST['to'])) {
		...
		<div id="message" class="updated fade">
			<p><strong><?php _e('Test Message Sent', 'wp_mail_smtp'); ?></strong></p>
			...
			?>
		<div class="wrap">
			<h2><?php _e('Cấu hình gửi mail', 'wp_mail_smtp'); ?></h2>
			<form method="post" action="options.php">
				...
				<table class="optiontable form-table">
					...
					<tr valign="top">
						...
						<td>
							<fieldset><legend class="screen-reader-text"><span><?php _e('Encryption', 'wp_mail_smtp'); ?></span></legend>
			...
			<form method="POST" action="options-general.php?page=wp_mail_smtp">
...
function wp_mail_smtp_menus() {
	...
	if (function_exists('add_submenu_page')) {
		add_options_page(__('Advanced Email Options', 'wp_mail_smtp'),__('Gửi Email', 'wp_mail_smtp'),'manage_options', 'wp_mail_smtp.php','wp_mail_smtp_options_page');
	}
...
function wp_mail_plugin_action_links( $links, $file ) {
	if ( $file != 'wp_mail_smtp')
		return $links;

	$settings_link = '<a href="options-general.php?page=wp_mail_smtp">' . __( 'Settings', 'wp_mail_smtp' ) . '</a>';
