					...
					if (! empty($show_byline_extra) && ! empty($post_info_extra)) {
						...
						if ($show_card_title_extra == "card_h") {
							...
							if (! empty($link_category)) {
								...
								$listitems .= sprintf(
									'<li><a href="%s" title="%s" class="%s">%s</a><p class="name-category"><a href="%s">%s</a></p><p class="byline post-info">%s</p><h3><a href="%s" title="%s">%s</a></h3></li>',
									get_permalink(),
									$cur_post_title_attr,
								...
								$listitems .= sprintf(
									'<li><a href="%s" title="%s" class="%s">%s</a><p class="byline post-info">%s</p><h3><a href="%s" title="%s">%s</a></h3></li>',
									get_permalink(),
									$cur_post_title_attr,
									esc_attr($image_alignment_extra),
									genesis_get_image(array(
        ...
        <div class="box-info">
            ...
            <a href="%s" class="read-more">Xem thêm</a>
						...
						if ($show_card_title_extra == "card_h") {
							...
							$listitems .= sprintf(
								'<li><a href="%s" title="%s" class="%s">%s</a><h3><a href="%s" title="%s">%s</a></h3></li>',
								get_permalink(),
								$cur_post_title_attr,
								esc_attr($image_alignment_extra),
								genesis_get_image(array(
							...
							// đảm bảo permalink và title attribute được định nghĩa
		...
		<div class="extra-wrap">
			...
			<p class="extra-desc">%s</p>
					...
					if (! empty($show_byline_extra) && ! empty($post_info_extra)) {
						if ($show_card_title_extra == "card_h") {
							$listitems .= sprintf(
								'<li><a href="%s" title="%s"><h3>%s</h3></a><p class="byline post-info">%s</p></li>',
								get_permalink(),
								the_title_attribute('echo=0'),
								get_the_title(),
								do_shortcode($post_info_extra)
							...
							$listitems .= sprintf(
								'<li><a href="%s" title="%s">%s</a><p class="byline post-info">%s</p></li>',
								get_permalink(),
								the_title_attribute('echo=0'),
								get_the_title(),
								do_shortcode($post_info_extra)
						...
						if ($show_card_title_extra == "card_h") {
							$listitems .= sprintf(
								'<li><h3><a href="%s" title="%s">%s</a></h3></li>',
								get_permalink(),
								the_title_attribute('echo=0'),
								get_the_title()
							);
