...
<h3><?php _e('Cấu hình hiển thị widget', DW_L10N_DOMAIN); ?>: <em><?php echo $DW->getName($widget_id); ?></em></h3>
<?php echo ( DW_DEBUG ) ? '<pre>ID = ' . $widget_id . '</pre><br />' : ''; ?>

<div class="settingbox">
<b><?php _e('Thiết lập nhanh', DW_L10N_DOMAIN); ?></b>
<p>
<a href="#" onclick="setOff(); return false;">Thiết lập tất cả về '<?php _e('No')?>'</a> (ngoại trừ một vài thiết lập về Role, Date, ...')
</p>
</div><br />
...
<!-- Caia: ngầm định ẩn setting individual -->
<div class="settingbox" style="display:none;">
...
<input type="button" value="Mở rộng - Thu gọn" onclick="toggleAll();" /><br />
<br />
