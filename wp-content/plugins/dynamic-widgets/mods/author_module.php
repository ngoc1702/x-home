 ...
 */
	...
	class DW_Author extends DWModule {
		protected static $except =  'Ngoại trừ tác giả'; //'Except the author(s)';
		public static $option = array( 'author' => 'Author Pages' );
		protected static $question = 'Hiển thị widget trên trang tác giả'; // 'Show widget default on author pages?';
